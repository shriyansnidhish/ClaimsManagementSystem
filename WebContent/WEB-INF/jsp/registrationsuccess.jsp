...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right" id="navbr">
      <li><a href="adminlogin.htm" style="color:yellow;"><span class="glyphicon glyphicon-user" ></span> LogIn</a></li>
    </ul>
  </div>
</nav> 
...
<h3 style="padding-left: 5%; color:red;">Your ID Is : <c:out value="${adminId}"/></h3>
</center>
</div>
<!-- Login End -->
