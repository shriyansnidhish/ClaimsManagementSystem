...
<table>
<tr>
<th>planCode</th> <th>planDescription</th> <th>coverage1</th> <th>coverage2</th> <th>coverage3</th> <th>coverage4</th><th>coverage5</th>

</tr>
 <c:forEach items="${planById}" var="onePlan">             
<tr>

<td><c:out value="${onePlan.planCode}"/></td>
<td><c:out value="${onePlan.planDescription}"/></td>
<td><c:out value="${onePlan.coverage1}"/></td>
<td><c:out value="${onePlan.coverage2}"/></td>
<td><c:out value="${onePlan.coverage3}"/></td>
<td><c:out value="${onePlan.coverage4}"/></td>
<td><c:out value="${onePlan.coverage5}"/></td>
