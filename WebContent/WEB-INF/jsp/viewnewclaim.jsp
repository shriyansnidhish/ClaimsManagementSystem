...
<tr>
<th style="color:yellow; background-color:blue;" ><center>Pending Claim ID  </center></th>
</tr>
<c:forEach items="${newClaimList}" var="claim">
<tr>
<td ><center><a  href="viewoneclaim.htm?claimId=${claim.claimId}"><c:out value="${claim.claimId}"/></a></center></td>
