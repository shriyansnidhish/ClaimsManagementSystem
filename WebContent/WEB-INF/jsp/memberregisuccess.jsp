...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right" id="navbr">
      <li><a href="memberlogin.htm" style="color:yellow;"><span class="glyphicon glyphicon-user" ></span> LogIN</a></li>
    </ul>
  </div>
</nav> 
...
<div>
  <center>
  <h1 style="padding-left: 5%; padding-top: 5%; color:green;">Your details are submitted successfully</h1><br><br>
<h3 style="padding-left: 5%; color:red;">Your ID Is : <c:out value="${memberId}"/></h3>
</center>
</div>
<!-- Login End -->
