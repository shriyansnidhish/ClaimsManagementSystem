...
<form align="center" name="memberId" method="get" action="memberbyid.htm" onsubmit="return checkinput()">
			<b style="color:white;">Id&nbsp;:</b> <input class="box" type="text" name="memberId"/><br><br>
			

			<input id="styled" type="submit" value="Search"><br>
