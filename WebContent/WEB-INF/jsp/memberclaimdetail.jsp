...
<tr>
<th style="color:yellow; background-color:blue;" ><center>Claims</center></th>
</tr><br>
<c:forEach items="${memberClaimsList}" var="memberClaim">
<tr>
<td  ><center><a href="viewonememberclaim.htm?claimId=${memberClaim.claimId}" ><c:out value="${memberClaim.claimId}"/></a></center></td>
