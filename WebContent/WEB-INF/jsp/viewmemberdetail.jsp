...
<table border="1" style="color:#337ab7; ">
<br>
...
<td id="display"><c:out value="${oneMember.planCode}"/></td>
</tr>
...
<tr border="0">
<td id="display"></td><td id="display">
<b><a style="color:green;" href="changeRegistrationStatus.htm?memberId=${oneMember.memberId}&action=Accept">Accept</a></b><br><br></td></tr>
<tr border="0"><td id="display"></td><td id="display"><b><a style="color:red;" href="changeRegistrationStatus.htm?memberId=${oneMember.memberId}&action=Reject">Reject</a></b></td>
</tr>
